...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2025 a las 20:13:32
...
CREATE TABLE `admin` (
  ...
  `pregunta1` enum('NOMBRE DE MADRE','NOMBRE DE PADRE','COLOR PREFERIDO') NOT NULL,
  `repuesta1` varchar(150) NOT NULL,
  `pregunta2` enum('APELLIDO DE MADRE','APELLIDO DE PADE','CIUDAD DE NACIMIENTO') NOT NULL,
  `repuesta2` varchar(150) NOT NULL,
  `pregunta3` enum('COMIDA PREFERIDA','PELICULA PREFERIDA','NOMBRE MASCOTA') NOT NULL,
  `repuesta3` varchar(100) NOT NULL,
...
INSERT INTO `admin` (`id_admin`, `usuario`, `contraseña`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `pregunta1`, `repuesta1`, `pregunta2`, `repuesta2`, `pregunta3`, `repuesta3`, `tipo_doc`, `num_doc`, `correo`, `fecha_nac`, `telefono`, `status`) VALUES
(1, 'Jhonnifer12345', '', 'Jhonnifer', 'Jhonnier', 'Cañizalez', 'Rodriguez', '', '', '', '', '', '', 'V', '27649608', 'jhonnif.11@gmail.com', '2000-12-25', '04120541404', 'ACTIVO');
...
INSERT INTO `agenda` (`id_agenda`, `fecha`, `hora_inicio`, `hora_final`, `contador_cita`, `id_paciente`, `status`) VALUES
(1, '2025-06-24', '13:11:40', '44:11:40', 45, 1, 'confirmada');
...
INSERT INTO `citas` (`id_cita`, `id_agenda`, `id_psicologo`, `id_paciente`, `id_tipo_cita`, `fecha`, `motivo_cita`) VALUES
(1, 1, 1, 1, 11, '2025-06-12 20:03:06', 'COMPROBAR DEMENCIA');
...
INSERT INTO `direcciones` (`id_direccion`, `id_estado`, `id_municipio`, `id_parroquia`, `id_ciudad`, `id_persona`) VALUES
(1, 12, 146, 468, 212, 1);
...
CREATE TABLE `empresa` (
  ...
  `tipo_documento` enum('V','J') NOT NULL,
  `n_documento` varchar(15) NOT NULL,
  `direccion` varchar(150) NOT NULL,
  `correo` varchar(150) NOT NULL,
  `celular_local` varchar(150) NOT NULL,
  `celular_movil` varchar(150) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `empresa` (`id_empresa`, `razon_social`, `tipo_documento`, `n_documento`, `direccion`, `correo`, `celular_local`, `celular_movil`) VALUES
(1, 'ayudar', 'V', '27649608', 'lara barquisimeto', 'crjj27649608@gmai.com', '02511234567', '04120541404');
...
INSERT INTO `factura` (`id_factura`, `fecha`, `id_paciente`, `monto`, `id_pago_cita`, `status`) VALUES
(1, '2025-06-24', 1, 1200, 1, 'REALIZADO'),
(2, '2025-06-01', 1, 1200, 1, 'PENDIENTE');
...
CREATE TABLE `historial` (
  ...
  `inicio_terapia` text NOT NULL,
  `tiempo_problem` text NOT NULL,
  `suceso_dia` text NOT NULL,
  `que_hizo` text NOT NULL,
  `hablo_del_problema` text NOT NULL,
  `factores_del_problema` text NOT NULL,
  `tratamiento_psicologico` text NOT NULL,
  `ultimo_tratamiento` text NOT NULL,
  `autodescrip_personal` text NOT NULL,
...
INSERT INTO `historial` (`id_historial`, `motivo`, `inicio_terapia`, `tiempo_problem`, `suceso_dia`, `que_hizo`, `hablo_del_problema`, `factores_del_problema`, `tratamiento_psicologico`, `ultimo_tratamiento`, `autodescrip_personal`, `id_usuario`) VALUES
(1, 'sentimental', 'junio', '5 meses', 'llorar', 'llorar', 'si ', 'problemas en clases de oswaldo', 'si', 'nunca', 'una persona sentimental', 1);
...
CREATE TABLE `incidencias` (
  ...
  `tipo_incidencia` enum('DOCUMENTOS EXTRAVIADOS','ACCIDENTE DE PACIENTE') NOT NULL,
  `fecha_hora` datetime NOT NULL,
  `impacto_paciente` varchar(100) NOT NULL,
  `acciones_tomadas` varchar(100) NOT NULL,
  `seguimiento` varchar(100) NOT NULL,
  `observacion` varchar(100) NOT NULL,
  `status` enum('ABIERTO','CERRADO','EN PROCESO') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `incidencias` (`id_incidencia`, `id_paciente`, `id_psicologo`, `descripcion_detallada`, `tipo_incidencia`, `fecha_hora`, `impacto_paciente`, `acciones_tomadas`, `seguimiento`, `observacion`, `status`) VALUES
(11, 1, 1, 'problemas mentales por culpa de oswwaldo', 'ACCIDENTE DE PACIENTE', '2025-06-12 19:50:37', 'doloroso', 'pastillas', 'en proceso', 'terminar la materia', 'EN PROCESO');
...
CREATE TABLE `pacientes` (
  ...
  `discapacidad` tinyint(10) NOT NULL,
  `desc_discapacidad` varchar(300) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `id_direccion` int(11) NOT NULL,
  `edad_hijos` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pacientes` (`id_paciente`, `num_hijos`, `discapacidad`, `desc_discapacidad`, `id_usuario`, `id_direccion`, `edad_hijos`) VALUES
(1, 1, 1, 'qjqjqjqjq', 1, 1, 1);
...
CREATE TABLE `pago_cita` (
  ...
  `tipo_pago` enum('TRANSFERENCIA BANCARIA','PAGO MOVIL','PAGO EN EFECTIVO') NOT NULL,
...
(1, 1, 'PAGO EN EFECTIVO', 1200, '2025-06-12', 1234);
...
INSERT INTO `personas` (`id_personas`, `id_usuarios`, `tipo_documento`, `n_documento`, `direccion_principal`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `fecha_nacimiento`, `n_telefono`, `correo`, `status`) VALUES
(1, 1, 'V', '27649608', 'el carmen', 'jhonnifer', 'jhonnier', 'cañizalez', 'rodriguez', '2000-12-25', '04120541404', 'jhonnif.11@gmail.com', 'activo'),
(2, 22, 'V', '12345678', 'barqusimeto', 'qqqqq', 'wwww', 'eeeee', 'rrrrr', '2025-06-20', '04120541404', 'crjj27649608@gmail.com', 'activo');
...
INSERT INTO `psicologo` (`id_psicologo`, `id_admin`) VALUES
(1, 1),
(2, 1);
...
CREATE TABLE `relacion_pacientes` (
  ...
  `id_paciente` int(11) NOT NULL,
  `relacion_familiar` enum('HIJO','PAREJA','SOBRINO','AHIJADO','OTROS') NOT NULL,
  ...
  `relacion_tipo_doc` enum('V','E','J') NOT NULL,
  `relacion_numero_doc` varchar(12) NOT NULL,
  `relacion_discapacitado` tinyint(4) NOT NULL,
  `relacion_descrip_disca` varchar(150) NOT NULL,
  `relacion_telefono` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `relacion_pacientes` (`id_relacion_paciente`, `id_paciente`, `relacion_familiar`, `relacion_nombre1`, `relacion_nombre2`, `relacion_apellido1`, `relacion_apellido2`, `relacion_fecha_nac`, `relacion_tipo_doc`, `relacion_numero_doc`, `relacion_discapacitado`, `relacion_descrip_disca`, `relacion_telefono`) VALUES
(1, 1, 'OTROS', 'jhonnifer', 'jhonnier', 'cañizalez', 'rodriguez', '2025-06-30', 'V', '27649608', 1, 'discapacidad', 412054140);
...
CREATE TABLE `reportes` (
  `id_reportes` int(50) NOT NULL,
  `id_persona` int(50) NOT NULL,
  `id_incidencia` int(50) NOT NULL,
...
INSERT INTO `reportes` (`id_reportes`, `id_persona`, `id_incidencia`, `detalles`, `observaciones`, `fecha_reporte`, `status`) VALUES
(1, 1, 1, 'problemas hsdafdtfdsaas', 'problemas mentales', '2025-06-05', 'activo'),
(2, 2, 2, 'desastre mental por oswaldo', 'necesita ir al psiquiatra', '2025-06-19', 'activo');
...
CREATE TABLE `tipo_cita` (
  `id_tipo_cita` int(20) NOT NULL,
  `tipo_cita` enum('INFANTIL','ADOLECENTE','ADULTO','PAREJA') NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `pregunta1` enum('NOMBRE DE MADRE','NOMBRE DE PADRE','COLOR PREFERIDO') NOT NULL,
  `repuesta1` varchar(100) NOT NULL,
  `pregunta2` enum('APELLIDO DE MADRE','APELLIDO DE PADRE','CIUDAD DE NACIMIENTO') NOT NULL,
  `repuesta2` varchar(100) NOT NULL,
  `pregunta3` enum('COMIDA PREFERIDA','PELICULA PREFERIDA','NOMBRE DE MASCOTA') NOT NULL,
  `repuesta3` varchar(100) NOT NULL,
  `status` enum('activo','inactivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usuarios` (`id_usuarios`, `usuario`, `tipo_doc`, `num_doc`, `correo`, `contraseña`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `fecha_naci`, `telefono`, `sexo`, `pregunta1`, `repuesta1`, `pregunta2`, `repuesta2`, `pregunta3`, `repuesta3`, `status`) VALUES
(1, 'jhonnifer', 'V', '27649608', 'Crjj27649608@gmail.com', '123456789', 'jhonnifer', 'jhonnier', 'cañicalez', 'rodriguez', '2000-12-25', '04120541404', 'MASCULINO', 'NOMBRE DE MADRE', 'enmi', 'APELLIDO DE MADRE', 'silva', 'PELICULA PREFERIDA', 'peli', 'activo'),
(2, 'asdfgh', 'V', '12345678', 'jhonnif.11@gmail.com', '1234567890', 'sdfghj', 'qwerty', 'asdfgh', 'qwerty', '2025-06-04', '04120567247', 'FEMENINO', 'COLOR PREFERIDO', 'morado', 'CIUDAD DE NACIMIENTO', 'barqusimeto', 'NOMBRE DE MASCOTA', 'asdafd', 'activo'),
(22, 'jhonnifer', 'V', '27649607', 'asdfghj@gmai.com', '12345678', 'jhonnifer', 'jhonnier', 'cañizalez', 'rodriguez', '2024-06-12', '04120567247', 'MASCULINO', 'NOMBRE DE MADRE', 'asdfgh', 'APELLIDO DE MADRE', 'asdfghj', 'COMIDA PREFERIDA', 'qwertyu', 'activo'),
(77, 'jhonnifer', 'V', '27649608', 'qwertyui@gmai.com', '0987654321', 'zxcvbn', 'qwertyui', 'qwertyu', 'qwerty', '2021-06-01', '04120541404', 'FEMENINO', 'NOMBRE DE MADRE', 'asdfghj', 'APELLIDO DE MADRE', 'qwertyu', 'COMIDA PREFERIDA', 'qwertyui', 'activo');
...
ALTER TABLE `relacion_pacientes`
  ADD PRIMARY KEY (`id_relacion_paciente`),
  ADD KEY `id_paciente` (`id_paciente`);
...
--
ALTER TABLE `pago_cita`
  MODIFY `id_pago_cita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `personas`
  MODIFY `id_personas` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `relacion_pacientes`
  MODIFY `id_relacion_paciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `reportes`
--
ALTER TABLE `reportes`
  MODIFY `id_reportes` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tipo_cita`
--
ALTER TABLE `tipo_cita`
  MODIFY `id_tipo_cita` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usuarios` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
ALTER TABLE `agenda`
  ADD CONSTRAINT `agenda_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_paciente`);

--
-- Filtros para la tabla `citas`
--
ALTER TABLE `citas`
  ADD CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`id_tipo_cita`) REFERENCES `tipo_cita` (`id_tipo_cita`),
  ADD CONSTRAINT `citas_ibfk_2` FOREIGN KEY (`id_agenda`) REFERENCES `agenda` (`id_agenda`),
  ADD CONSTRAINT `citas_ibfk_3` FOREIGN KEY (`id_psicologo`) REFERENCES `psicologo` (`id_psicologo`),
  ADD CONSTRAINT `citas_ibfk_4` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_paciente`);
...
--
ALTER TABLE `direcciones`
  ADD CONSTRAINT `direcciones_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `direcciones_ibfk_2` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `direcciones_ibfk_3` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`),
  ADD CONSTRAINT `direcciones_ibfk_4` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`),
  ADD CONSTRAINT `direcciones_ibfk_5` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id_personas`);
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`id_pago_cita`) REFERENCES `pago_cita` (`id_pago_cita`);

--
-- Filtros para la tabla `historial`
--
ALTER TABLE `historial`
  ADD CONSTRAINT `historial_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuarios`);

--
-- Filtros para la tabla `incidencias`
--
ALTER TABLE `incidencias`
  ADD CONSTRAINT `incidencias_ibfk_2` FOREIGN KEY (`id_psicologo`) REFERENCES `psicologo` (`id_psicologo`),
  ADD CONSTRAINT `incidencias_ibfk_3` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_paciente`);
...
--
ALTER TABLE `pacientes`
  ADD CONSTRAINT `pacientes_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuarios`),
...
--
ALTER TABLE `pago_cita`
  ADD CONSTRAINT `pago_cita_ibfk_1` FOREIGN KEY (`id_cita`) REFERENCES `citas` (`id_cita`);
...
--
ALTER TABLE `personas`
  ADD CONSTRAINT `personas_ibfk_1` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id_usuarios`);

--
-- Filtros para la tabla `psicologo`
--
ALTER TABLE `psicologo`
  ADD CONSTRAINT `psicologo_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`);

--
-- Filtros para la tabla `relacion_pacientes`
--
ALTER TABLE `relacion_pacientes`
  ADD CONSTRAINT `relacion_pacientes_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_paciente`);

--
-- Filtros para la tabla `reportes`
--
ALTER TABLE `reportes`
  ADD CONSTRAINT `reportes_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id_personas`);
COMMIT;
