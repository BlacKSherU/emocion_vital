...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2025 a las 22:26:19
...
CREATE TABLE `pago_cita` (
  ...
  `tipo_pago` enum('TRANSFERENCIA BANCARIA','PAGO MOVIL','PGO EN EFECTIVO') NOT NULL,
...
--
ALTER TABLE `pago_cita`
  MODIFY `id_pago_cita` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `personas`
  MODIFY `id_personas` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `reportes`
  MODIFY `id_reportes` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tipo_cita`
--
ALTER TABLE `tipo_cita`
  MODIFY `id_tipo_cita` int(20) NOT NULL AUTO_INCREMENT;
